...
abstract class BaseDCAEAnalyticsCommonTest {
     ...
     */
    public static String fromStream(final String fileLocation) throws IOException {
        final InputStream jsonFileInputStream =
                Thread.currentThread().getContextClassLoader().getResourceAsStream(fileLocation);
        Assertions.assertNotNull(jsonFileInputStream, "Json File Location must be valid");
     ...
     * @throws IOException IOException
     */
    public static void testSerialization(final Object object, final Class<?> callingClass) throws IOException {
     ...
     * @throws IOException - ioException
     */
    public static void writeToOutputTextFile(final String textFileLocation, final String content,
