...
public abstract class AnalyticsModelIOUtils extends AnalyticsModelJsonUtils {
     ...
     */
    public static final <T> T convertToJsonObject(final String fileLocation, final Class<T> bindingClass) throws
            IOException {
     ...
     */
    public static Properties loadPropertiesFile(final String propertiesFileLocation, final Properties properties) {
        ...
        if (propertiesFileInputStream == null) {
            ...
            throw new IllegalArgumentException(errorMessage, new FileNotFoundException(errorMessage));
        }
     ...
     */
    public static InputStream loadResourceAsStream(final String fileLocation) {
        // Load Resource from give path
