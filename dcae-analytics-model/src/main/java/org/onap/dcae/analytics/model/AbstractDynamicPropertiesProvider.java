 ...
 */
@Data
public abstract class AbstractDynamicPropertiesProvider implements DynamicPropertiesProvider {
     ...
     */
    @Override
    public void addDynamicProperties(final String propertyName, final Object propertyValue) {
