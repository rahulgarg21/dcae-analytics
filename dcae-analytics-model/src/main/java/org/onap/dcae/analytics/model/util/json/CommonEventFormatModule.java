...
import org.onap.dcae.analytics.model.domain.cef.AbstractCEFModel;
import org.onap.dcae.analytics.model.domain.cef.AlertAction;
import org.onap.dcae.analytics.model.domain.cef.AlertType;
import org.onap.dcae.analytics.model.domain.cef.CommonEventHeader;
import org.onap.dcae.analytics.model.domain.cef.Criticality;
import org.onap.dcae.analytics.model.domain.cef.Domain;
import org.onap.dcae.analytics.model.domain.cef.Event;
import org.onap.dcae.analytics.model.domain.cef.EventListener;
import org.onap.dcae.analytics.model.domain.cef.EventSeverity;
import org.onap.dcae.analytics.model.domain.cef.Field;
import org.onap.dcae.analytics.model.domain.cef.InternalHeaderFields;
import org.onap.dcae.analytics.model.domain.cef.MeasurementsForVfScalingFields;
import org.onap.dcae.analytics.model.domain.cef.NamedArrayOfFields;
import org.onap.dcae.analytics.model.domain.cef.PerformanceCounter;
import org.onap.dcae.analytics.model.domain.cef.Priority;
import org.onap.dcae.analytics.model.domain.cef.ThresholdCrossingAlertFields;
import org.onap.dcae.analytics.model.domain.cef.VNicPerformance;
...
public class CommonEventFormatModule extends SimpleModule {
    ...
    public void setupModule(final SetupContext setupContext) {
        ...
        setupContext.setMixInAnnotations(AbstractCEFModel.class, BaseCEFModelMixin.class);
