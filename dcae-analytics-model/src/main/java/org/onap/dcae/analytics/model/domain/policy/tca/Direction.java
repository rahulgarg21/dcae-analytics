...
public enum Direction implements TCAPolicyModel {
    ...
    EQUAL {
        @Override
        public Boolean operate(@Nonnull final BigDecimal value1, @Nonnull final BigDecimal value2) {
     ...
     */
    public abstract Boolean operate(@Nonnull final BigDecimal value1, @Nonnull final BigDecimal value2);
