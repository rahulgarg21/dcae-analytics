...
public abstract class AnalyticsModelJsonUtils {
     ...
     */
    public static <T> T readValue(final InputStream inputStream, final TypeReference<T> valueTypeRef) throws
            IOException {
     ...
     * @throws IOException IO Exception
     */
    public static <T> T readValue(final InputStream inputStream, final Class<T> targetClass) throws IOException {
