...
public class MetricsPerEventName extends AbstractTCAPolicyModel {
    ...
    public static MetricsPerEventName copy(final MetricsPerEventName metricsPerEventName) {
        ...
        if (metricsPerEventName.getThresholds() != null) {
            final List<Threshold> newThresholds = new ArrayList<>(metricsPerEventName.getThresholds().size());
            for (final Threshold threshold : metricsPerEventName.getThresholds()) {
