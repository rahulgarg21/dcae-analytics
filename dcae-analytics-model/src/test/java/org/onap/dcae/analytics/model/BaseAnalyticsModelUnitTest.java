...
import org.onap.dcae.analytics.model.util.json.AnalyticsModelObjectMapperSupplier;
...
public abstract class BaseAnalyticsModelUnitTest extends BaseDCAEAnalyticsUnitTest {
     ...
     */
    public static <T> T assertJsonDeserialization(final String jsonFileLocation,
                                                  final Class<T> modelClass, T expectedJsonObject) {
     ...
     */
    public static String serializeModelToJson(final Object model) throws JsonProcessingException {
